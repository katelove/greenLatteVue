<template>
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item href="#sec3" v-if="$store.getters.getSiteNum==1">檢視健康</b-nav-item>
        <b-nav-item href="#sec4" v-if="$store.getters.getSiteNum==2">綠拿鐵</b-nav-item>
        <b-nav-item href="#sec5" v-if="$store.getters.getSiteNum==3">蔬果卡</b-nav-item>
        <b-nav-item href="#sec6" v-if="$store.getters.getSiteNum==4">綠市場</b-nav-item>
        <b-nav-item href="#sec7" v-if="$store.getters.getSiteNum==5">DIY</b-nav-item>
        <b-nav-item href="#sec8" v-if="$store.getters.getSiteNum==6">周計劃</b-nav-item>
        <b-nav-item href="#sec9" v-if="$store.getters.getSiteNum==7">三餐日誌</b-nav-item>
